...
def get_url():
    return "http://%s/api" % app.config['api_host'] # http://127.0.0.1:2000/api
...
def listapi():
    ...
    data['method'] = method+".getlist"      # ./api/jigui.py:9:@jsonrpc.method('jigui.getlist')
    data['params'] = {} 
...
def addapi():
    ...
    data['method'] = method+".create"       # ./api/zabbix.py:159:@jsonrpc.method('zabbix_maintenance.create')
